...
autocmd FileType markdown map <Leader>h4 :.!$HOME/.vim/bundle/vim-rst/bin/text-helper markdown h4<Cr><Cr>
autocmd FileType markdown map <Leader>h5 :.!$HOME/.vim/bundle/vim-rst/bin/text-helper markdown h5<Cr><Cr>
autocmd FileType markdown map <Leader>img :.!$HOME/.vim/bundle/vim-rst/bin/text-helper markdown img<Cr><Cr>
autocmd FileType markdown map <Leader>l :.!$HOME/.vim/bundle/vim-rst/bin/text-helper markdown link<Cr><Cr>
